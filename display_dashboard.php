...
<head>
  ...
  <title>Disply Dashboard - Admin</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Dispaly data</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <?php
            ...
            switch ($_GET['page']) {
                case "clientstable":
                     include "display/clients-table-display.php";
                break;

                case "activeclientstable":
                    include "display/active-clients-table-display.php";
               break;
                
               case "headstable":
                include "display/heads-table-display.php";
           break;
           case "ledgerstable":
            include "display/ledgers-table-display.php";
       break;

           
       case "intemstable":
        include "display/items-table-display.php";
   break;

   case "firmstable":
    include "display/firms-table-display.php";
break;

case "signingtable":
    include "display/signing-partner-table-display.php";
break;

case "headsseqtable":
    include "display/heads-sequence-table-display.php";
break;

case "transactiontable":
    include "display/transactions-table-display.php";
break;

case "scheduletable":
    include "display/schedule-note-numbers-table-display.php";
break;

case "art":
    include "display/audit-report-table-display.php";
break;

case "rit":
    include "display/report-information-table-display.php";
break;


                default:
                    //  include "student/home.php";
                    header("Location : display/clients-table-display.php");
                };
            }
