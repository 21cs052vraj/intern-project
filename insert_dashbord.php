...
<body>
  ...
  <main id="main" class="main">
    ...
    <?php
            ...
            switch ($_GET['page']) {
                case "clientstable":
                     include "clients-table.php";
                break;

                case "activeclientstable":
                    include "active-clients-table.php";
               break;
                
               case "headstable":
                include "head-table.php";
           break;
           case "ledgerstable":
            include "ledgers-table.php";
       break;

           
       case "intemstable":
        include "items-table.php";
   break;

   case "firmstable":
    include "firms-table.php";
break;

case "signingtable":
    include "signing-partner-table.php";
break;

case "headsseqtable":
    include "heads-sequence.php";
break;

case "transactiontable":
    include "transactions-table.php";
break;

case "scheduletable":
    include "schedule-note-numbers-table.php";
break;

case "art":
    include "audit-report-table.php";
break;

case "rit":
    include "report-information-table.php";
break;
