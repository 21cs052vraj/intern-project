...
<body>
  ...
  <div class="content table-responsive style="color: white;"">
    ...
    <h3 class="h3 my-3 formate text-center">Heads Sequence Table</h3>
      ...
      <div class="col-lg-12">
        ...
        <table id="tabledata" class=" table table-striped table-hover table-bordered">
          ...
          <tr class="bg-dark text-white text-center">
            ...
            <th style="color: white;">unique identifier for each clientClient Type :</th>
            <th style="color: white;">Report Type : </th>
            <th style="color: white;">Side (Debit/Credit) : </th>
            <th style="color: white;">Sequence Sr. No. : </th>
          ...
          $q = "select * from heads_sequence_table";
          ...
          ?>
            <tr class="text-center">
              ...
              <td> <?php echo $res['SIDE'];  ?> </td>
              <td> <?php echo $res['SRN'];  ?> </td>
