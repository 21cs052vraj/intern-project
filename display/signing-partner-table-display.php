            ...
            <br> -->
                <table id="tabledata" class=" table table-striped table-hover table-bordered">
                    ...
                    <tr class="bg-dark text-white text-center">
                        ...
                        <th style="color: white;">ICAI Membership No. : </th>
                        <th style="color: white;">Name of the signing partner : </th>
                        <th style="color: white;">Active Firm (New field created for each FIRMS.FID) : </th>
                    </tr>
                    ...
                    $q = "SELECT * FROM signing_partner_table";
