            ...
            <br> -->
                <table id="tabledata" class=" table table-striped table-hover table-bordered">
                    ...
                    <tr class="bg-dark text-white text-center">
                        ...
                        <th>Unique Identifier for each item : </th>
                        <th>Unique Identifier of Level 2 : </th>
                        <th>Text of reported heading : </th>
                        <th>Side of each item (Debit/Credit) : </th>
                        <th>CID for client-specific ledgers : </th>
                        <th>Active Item (New Entry Allowed) : </th>
