...
if (isset($_POST['done'])) {
    ...
    $q = "UPDATE `signing_partner_table` SET `MID`='$t71',`MNAME`='$t71',`(FIRMS.FID)`='$t71' WHERE `MID`=$t71";
    ...
    <form form action="" class="formate my-3" method="post">
      <div class="row mb-3 my-2 mx-2">
        ...
        <div class="col-sm-10 formate border">
          <input type="text" name="t71"class="form-control my-3" id="inputEmail3">
        </div>
      </div>
      <div class="row mb-3 mx-2">
        <label for="inputPassword3" class="col-sm-2 col-form-label formate border">Name of the signing partner  :  </label>
        <div class="col-sm-10 formate border">
          <input type="text" name="t72"class="form-control my-3" id="inputPassword3">
        </div>
      </div>
      <div class="row mb-3 my-2 mx-2">
        ...
        <div class="col-sm-10 formate border">
          <input type="text" name="t73"class="form-control my-3" id="inputEmail3">
        </div>
      </div>
