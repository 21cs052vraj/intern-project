...
if (isset($_POST['done'])) {
    ...
    $q = " UPDATE `heads_table` SET `HID`= '$t31',`HNAME`='$t32',`HTYPE`='$t33',`HSIDE`='$t34' WHERE `HID`= $t31";
...
<nav style="background-color:rgb(0, 255, 255) ;"  class="navbar navbar-expand-lg bg-body-tertiary ">
  <div class="container-fluid">
    ...
    <form form action="" class="formate my-3" method="post">
     ...
     <button class="btn-danger btn"> <a href="displayht.php?id=<?php?>" class="text-white"> Display </a> </button> 
     </div>
    </form>
  </section>
</div>
