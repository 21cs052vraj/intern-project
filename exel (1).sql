...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2023 at 11:41 AM
...
INSERT INTO `items_table` (`IID`, `LID`, `INAME`, `ISIDE`, `CID`, `ACTIVE`) VALUES
('', '', '', '', '', ''),
('12', '0', '', '', '0', '0');
...
--
-- Table structure for table `ledgers_table`
--

CREATE TABLE `ledgers_table` (
  `LID` varchar(255) NOT NULL,
  `HID` varchar(255) NOT NULL,
...
INSERT INTO `login` (`srno`, `username`, `password`) VALUES
(1, 'vraj', '1234');
...
--
-- Table structure for table `signing_partner_table`
--

CREATE TABLE `signing_partner_table` (
  `MID` varchar(255) NOT NULL,
...
--
-- Dumping data for table `signing_partner_table`
--

INSERT INTO `signing_partner_table` (`MID`, `MNAME`, `(FIRMS.FID)`) VALUES
('', '', ''),
('46758', '', '');
...
--
-- Indexes for table `ledgers_table`
--
ALTER TABLE `ledgers_table`
  ADD PRIMARY KEY (`LID`);
...
--
-- Indexes for table `signing_partner_table`
--
ALTER TABLE `signing_partner_table`
  ADD PRIMARY KEY (`MID`);
