...
if (isset($_POST['done'])) {
    ...
    if ($con->query($q) === TRUE) {
      ...
      window.location.assign("insert_dashbord.php?page=headsseqtable");
      </script>';
